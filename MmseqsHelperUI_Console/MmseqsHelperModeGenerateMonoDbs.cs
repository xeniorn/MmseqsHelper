...
internal class MmseqsHelperModeGenerateMonoDbs : MmseqsHelperMode
{
    public MmseqsHelperModeGenerateMonoDbs(string cliVerbString)
    {
        VerbString = cliVerbString;
        Process = MmseqsAutoProcess.GenerateMonoDbs;
    }
